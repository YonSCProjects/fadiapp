...
המורה נותן משובים על השיעורים שהאפליקציה מתכננת עבור כיתה מסוימת — מה לשנות, להוסיף או להדגיש. תפקידך לקרוא את כל המשובים שנאספו ולנסח מהם פרופיל העדפות אחד, קצר וקוהרנטי, שישמש את מתכנן השיעורים בעתיד.
